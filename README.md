# [Ansible role datadog](#ansible-role-datadog)

Install and configure Datadog on your systems.

|GitHub|GitLab|Downloads|Version|
|------|------|---------|-------|
|[![github](https://github.com/buluma/ansible-role-datadog/workflows/Ansible%20Molecule/badge.svg)](https://github.com/buluma/ansible-role-datadog/actions)|[![gitlab](https://gitlab.com/shadowwalker/ansible-role-datadog/badges/master/pipeline.svg)](https://gitlab.com/shadowwalker/ansible-role-datadog)|[![downloads](https://img.shields.io/ansible/role/d/buluma/datadog)](https://galaxy.ansible.com/buluma/datadog)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-datadog.svg)](https://github.com/buluma/ansible-role-datadog/releases/)|
...
If you find issues, please register them on [GitHub](https://github.com/buluma/ansible-role-datadog/issues).
